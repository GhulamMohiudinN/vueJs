...
<template>
  ...
  >
    <div class="absolute inset-0 bg-[#323232] bg-opacity-75">
      <div class="w-fit mx-auto pt-32">
        <img class="w-70 sm:w-90" src="@/assets/vueJs/logoDark.png" alt="" />
      </div>
      <div
        class="border-2 border-[black] bg-[#E6E6E7] text-black mt-16 w-[90%] sm:w-[435px] lg:w-[700px] mx-auto rounded-[50px] lg:rounded-[80px]"
      >
        <div>
          <p
        ...
        <div
          class="w-fit mx-auto lg:ml-[450px] md:ml-[270px] sm:mb-[-20px] mb-[-7%]"
        >
          <button
